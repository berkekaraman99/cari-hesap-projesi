    ...
    <div class="row">
      <div class="col">
        ...
        >
          <thead>
            <tr>
              <th class="col">Fatura No</th>
              <th class="col">Fatura Tarihi</th>
...
const { _customerReceipts: receipts } = storeToRefs(customerStore)
...
onBeforeMount(async () => {
  await customerStore.fetchReceipts(props.id)
})
</script>
